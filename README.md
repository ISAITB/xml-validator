...
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ISAITB_xml-validator&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ISAITB_xml-validator)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=ISAITB_xml-validator&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=ISAITB_xml-validator)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=ISAITB_xml-validator&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=ISAITB_xml-validator)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=ISAITB_xml-validator&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=ISAITB_xml-validator)
...
If you decide not to load any configurations, the generic XML validator configuration will be loaded instead. 
...
The domain of this generic validator is called **any**. you can access it like any other domain, from http://localhost:8080/any/upload.
